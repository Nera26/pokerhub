...
>(({ className, ...props }, ref) => <thead ref={ref} className={cn("[&_tr]:border-b border-dark", className)} {...props} />);
...
export const TableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr ref={ref} className={cn("border-b border-dark transition-colors hover:bg-hover-bg", className)} {...props} />
  )
);
...
export const TableFooter = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => <tfoot ref={ref} className={cn("border-t border-dark", className)} {...props} />
);
