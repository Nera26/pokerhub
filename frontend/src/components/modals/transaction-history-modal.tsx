...
} from '@/components/common/transaction-history-table';
...
import TransactionHistoryFilters from '@/components/common/transaction-history-filters';
import useTransactionHistoryExperience from '@/components/common/use-transaction-history-experience';
...
export default function TransactionHistoryModal({
  ...
  const { history, queries, metadata } = useTransactionHistoryExperience<
  ...
  const { typeSelect, performedBySelect } = metadata;
  const {
