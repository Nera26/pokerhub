...
import useTransactionHistoryColumns from '../use-transaction-history-columns';

jest.mock('../use-transaction-history-columns', () => {
  const actual = jest.requireActual('../use-transaction-history-columns');
  return {
    __esModule: true,
