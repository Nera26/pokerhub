...
import useTransactionHistoryExperience from '../use-transaction-history-experience';
import { useTransactionFilterQueries } from '@/hooks/useTransactionFilterQueries';
import { useTransactionHistoryControls } from '../transaction-history-controls';

jest.mock('@/hooks/useTransactionFilterQueries', () => ({
  useTransactionFilterQueries: jest.fn(),
}));

jest.mock('../transaction-history-controls', () => ({
